                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center">
                            ...
                            <div>
                                ...
                                @unless ($geography->created_at->eq($geography->updated_at))
                                    <small class="text-sm text-gray-600"> &middot; {{ __('edited') }}</small>
                                @endunless
                            </div>
                            @if ($geography->user->is(auth()->user()))
                                <x-dropdown>
                                    <x-slot name="trigger">
                                        <button>
                        ...
                        <p class="mt-4 text-lg text-gray-900">{{ $geography->title }}</p>
                        <p class="mt-4 text-lg text-gray-900">{{ $geography->content }}</p>
                    </div>
                </div>
            @endforeach
        </div>
