<x-app-layout>
  <div>
    <h1 class="mt-4 text-5xl text-gray-900 text-center decoration-black font-bold">Surfing The World Wide Waves</h1>
  </div>
  <div>
    <h2 class="mt-4 text-2xl text-gray-900 text-center">Articles I wrote for the school newspaper in the 90s</h2>
  </div>
